<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="viewdatanonshare.aspx.cs" Inherits="Irain_M.viewdatanonshare" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<title>IRAIN- VIEW AND DOWNLOAD NON-SHARE DATA</title>
    	...
    	<div id="secWrapper">
        	<div id="container" class="clearfix" style="text-align: left">
                <strong><span style="font-size: 10pt;">
                    ...
                    <br />
                    <br />
                    <span style="font-size: 12pt; color: #3366ff">VIEW AND DOWNLOAD NON-SHARE DATA<br />
                    </span></span></strong>
