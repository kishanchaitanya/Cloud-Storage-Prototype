...
namespace Irain_M
{
    public partial class viewdatanonshare : System.Web.UI.Page
    {
        ...
        protected void btnDocView_Click(object sender, EventArgs e)
        {
            ...
            tempFolderAbsolutePath = Server.MapPath("NonShareData//" + Session["UserName"].ToString() + "//Document");// @"C:\Temp";
        ...
        protected void btnAudioView_Click(object sender, EventArgs e)
        {
            ...
            tempFolderAbsolutePath = Server.MapPath("NonShareData//" + Session["UserName"].ToString() + "//Audio");// @"C:\Temp";
        ...
        protected void btnVideoView_Click(object sender, EventArgs e)
        {
            ...
            tempFolderAbsolutePath = Server.MapPath("NonShareData//" + Session["UserName"].ToString() + "//Video");// @"C:\Temp";
        ...
        protected void btnImagesView_Click(object sender, EventArgs e)
        {
            ...
            tempFolderAbsolutePath = Server.MapPath("NonShareData//" + Session["UserName"].ToString() + "//Image");// @"C:\Temp";
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            {
                strCurrentDir = Server.MapPath("NonShareData//" + Session["UserName"].ToString() + "//" + ViewState["fileType"] + "\\");
