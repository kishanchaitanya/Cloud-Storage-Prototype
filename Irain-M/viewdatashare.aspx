<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="viewdatashare.aspx.cs" Inherits="Irain_M.viewdatashare" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<title>IRAIN-VIEW AND DOWNLOAD SHARE DATA</title>
    	...
    	<div id="secWrapper">
        	<div id="container" class="clearfix" style="text-align: left">
                <strong><span style="font-size: 10pt;">
                    ...
                    <br />
                    <br />
                    <span style="font-size: 12pt; color: #3366ff">VIEW AND DOWNLOAD SHARE DATA<br />
                        <br />
                    </span></span></strong> &nbsp;<br />
                    <table>
...
<td style="width: 960px; height: 21px;">
    <asp:GridView ID="GridView1" runat="server" OnPageIndexChanging="GridView1_PageIndexChanging" AllowPaging="True" style="z-index: 100; left: 104px; position: relative; top: -6px;" CellPadding="4" Height="111px" 
      Width="756px" OnRowDataBound="GridView1_RowDataBound" OnRowDeleting="GridView1_RowDeleting" OnSelectedIndexChanging="GridView1_SelectedIndexChanging" OnRowCommand="GridView1_RowCommand" ForeColor="#333333" GridLines="None">
        ...
        <Columns>
            ...
            <asp:CommandField ButtonType="Button" HeaderText="DOWNLOAD" SelectText="Download" ShowSelectButton="True" />
    ...
    &nbsp;&nbsp;
                ...
                <br />
                <br />
                <span style="font-size: 14pt; color: #000000; line-height: 115%; font-family: 'Times New Roman','serif';
                    mso-bidi-font-weight: bold"> </span><span style="font-size: 14pt;
