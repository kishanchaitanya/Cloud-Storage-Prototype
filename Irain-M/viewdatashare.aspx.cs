...
namespace Irain_M
{
    public partial class viewdatashare : System.Web.UI.Page
    {
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            {
                if (e.Row.Cells[2].Text == "Item")
                {
                    e.Row.Cells[2].Text = "File Name";
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            {
                //GridView1.Rows[e.RowIndex].Cells[2].Visible=false;

                strCurrentDir = Server.MapPath("ShareData//" + ViewState["fileType"] + "\\");
            }

            string[] subFiles = Directory.GetFiles(strCurrentDir);
            //retrieve all the files and put them into a string array
            string[] names = Directory.GetFiles(strCurrentDir);
            ...
            GridView1.DataBind();
            _CommonUtilities.MessageBox("This Deleted Opration Is Deleted Successfully");


        }
        protected void GridView1_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
        {
            string FileName = GridView1.Rows[e.NewSelectedIndex].Cells[2].Text.ToString();
